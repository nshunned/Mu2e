...
void make_sum_scaled_plot(){
    ...
    */
    ...
    profile_1_f->GetYaxis()->SetTitle("normalized response");
    ...
    */
    ...
    legend_1->SetTextSize(0.05);
    legend_1->AddEntry(profile_1,"Default");
    legend_1->AddEntry(profile_5,"White_Paint");
    legend_1->Draw();
    ...
    profile_1_f->Write("Default");
    profile_5_f->Write("White_Paint");
    f_out->Close();
